...
fn compare_stage_b_svgs(args: Vec<String>, spec: StageBCompareSpec) -> Result<(), XtaskError> {
    ...
    let compare_paths = crate::cmd::compare_diagram_paths(spec.diagram_dir, out_path);
    ...
    let _ = writeln!(
        ...
        spec.report_title, spec.diagram_dir, spec.local_renderer, dom_mode, dom_decimals
    );
