...
fn scripted_renderer_width(diagram: &str) -> u32 {
    if diagram == "gantt" { 1200 } else { 800 }
}
        ...
        let render_results = map_bounded_in_order(mmd_files, jobs, |fixture| {
            ...
            let status = if use_scripted_renderer {
                ...
                let input_json = serde_json::json!({
                    ...
                    "svg_id": svg_id,
                    "seed": seed,
                    "width": scripted_renderer_width(diagram),
                    "height": 600,
...
mod tests {
    use super::{
        ...
        scripted_renderer_background_color, scripted_renderer_width, select_upstream_svg_diagrams,
