...
fn run_feature_matrix(
    ...
    let checks: &[(&str, &[&str])] = &[
        ...
        (
            "cargo nextest run -p merman-core --no-default-features --features full-registry --lib selected_supported_diagrams_follow_feature_profile",
            &[
                "nextest",
                "run",
                "-p",
                ...
                "full-registry",
                "--lib",
                "selected_supported_diagrams_follow_feature_profile",
            ],
        ),
        (
