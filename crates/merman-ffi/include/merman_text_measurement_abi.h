...
#define MERMAN_TEXT_MEASUREMENT_PROTOCOL_V2_VERSION 2
...
enum {
    ...
    MERMAN_TEXT_MEASUREMENT_OPERATION_NORMAL_LINE_METRICS = 19
};
...
enum {
    ...
    MERMAN_TEXT_MEASUREMENT_RESULT_KIND_NORMAL_LINE_METRICS = 4
};
