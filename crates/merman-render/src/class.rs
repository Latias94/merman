...
mod tests {
    use super::{
        TextStyle, class_html_known_calc_text_width_override_px,
        class_html_known_rendered_width_override_px,
    };
    ...
    #[test]
    fn class_rendered_width_overrides_are_generated() {
        let style = TextStyle::default();
        assert_eq!(
            class_html_known_rendered_width_override_px("Class01<T>", &style, true),
            Some(84.109375)
        );
        assert_eq!(
            class_html_known_rendered_width_override_px("+from(v: T) : Result<T>", &style, false),
            Some(166.9375)
        );
        assert_eq!(
            class_html_known_rendered_width_override_px(
