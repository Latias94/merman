...
pub fn lookup_flowchart_root_viewport_override(
    ...
    match diagram_id {
        ...
        "stress_flowchart_markdown_underscore_delims_074" => Some(("0 0 508.46875 65", "508.469")),
        ...
        "stress_flowchart_subgraph_title_leading_trailing_spaces_039" => {
            Some(("0 0 224 274", "224"))
        }
