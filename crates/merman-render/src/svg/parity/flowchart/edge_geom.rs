...
pub(super) use line_with_offset::{
    collapse_short_terminal_marker_stub, line_with_offset_for_edge_type,
    maybe_snap_shallow_basis_triplet_y_to_f32, rounded_line_with_marker_offsets_for_edge_type,
};
