...
complete -c merman-cli -n "__fish_merman_cli_needs_command" -f -a "rustdoc" -d 'Build or check committed static Mermaid fragments for Rustdoc'
...
complete -c merman-cli -n "__fish_merman_cli_using_subcommand rustdoc; and not __fish_seen_subcommand_from build check" -s h -l help -d 'Print help'
complete -c merman-cli -n "__fish_merman_cli_using_subcommand rustdoc; and not __fish_seen_subcommand_from build check" -s V -l version -d 'Print version'
