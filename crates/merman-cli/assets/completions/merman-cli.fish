...
svg\t''"
complete -c merman-cli -n "__fish_merman_cli_using_subcommand render" -s e -l format -d 'Output format. Defaults to the first compiled output format' -r -f -a "svg\t''
ascii\t''
unicode\t''
png\t''
jpg\t''
...
complete -c merman-cli -n "__fish_merman_cli_using_subcommand render" -s s -l scale -d 'PNG/JPG scale factor. Defaults to 1' -r
complete -c merman-cli -n "__fish_merman_cli_using_subcommand render" -l raster-fit-width -d 'Fit PNG/JPG raster output to this CSS-pixel width before applying --scale' -r
complete -c merman-cli -n "__fish_merman_cli_using_subcommand render" -l raster-fit-height -d 'Fit PNG/JPG raster output to this CSS-pixel height before applying --scale' -r
complete -c merman-cli -n "__fish_merman_cli_using_subcommand render" -l raster-max-width -d 'Maximum PNG/JPG output width after scale and fit. Defaults to 4096' -r
complete -c merman-cli -n "__fish_merman_cli_using_subcommand render" -l raster-max-height -d 'Maximum PNG/JPG output height after scale and fit. Defaults to 4096' -r
complete -c merman-cli -n "__fish_merman_cli_using_subcommand render" -l raster-max-pixels -d 'Maximum PNG/JPG output pixels after scale and fit. Defaults to 4096*4096' -r
...
complete -c merman-cli -n "__fish_merman_cli_using_subcommand render" -s t -l theme -d 'Mermaid theme override' -r
...
ratex\t''"
complete -c merman-cli -n "__fish_merman_cli_using_subcommand render" -s w -l width -d 'Available container width for size-sensitive layouts. `mmdc` defaults to 800' -r
complete -c merman-cli -n "__fish_merman_cli_using_subcommand render" -s H -l height -d 'Available container height for size-sensitive layouts. `mmdc` defaults to 600' -r
...
complete -c merman-cli -n "__fish_merman_cli_using_subcommand render" -l raster-unbounded -d 'Disable PNG/JPG raster size limits. Use only for trusted oversized exports'
...
complete -c merman-cli -n "__fish_merman_cli_using_subcommand batch" -s e -l format -d 'Output format. Defaults to SVG' -r -f -a "svg\t''
png\t''
jpg\t''
pdf\t''"
...
complete -c merman-cli -n "__fish_merman_cli_using_subcommand batch" -s s -l scale -d 'PNG/JPG scale factor. Defaults to 1' -r
complete -c merman-cli -n "__fish_merman_cli_using_subcommand batch" -l raster-fit-width -d 'Fit PNG/JPG raster output to this CSS-pixel width before applying --scale' -r
complete -c merman-cli -n "__fish_merman_cli_using_subcommand batch" -l raster-fit-height -d 'Fit PNG/JPG raster output to this CSS-pixel height before applying --scale' -r
complete -c merman-cli -n "__fish_merman_cli_using_subcommand batch" -l raster-max-width -d 'Maximum PNG/JPG output width after scale and fit. Defaults to 4096' -r
complete -c merman-cli -n "__fish_merman_cli_using_subcommand batch" -l raster-max-height -d 'Maximum PNG/JPG output height after scale and fit. Defaults to 4096' -r
complete -c merman-cli -n "__fish_merman_cli_using_subcommand batch" -l raster-max-pixels -d 'Maximum PNG/JPG output pixels after scale and fit. Defaults to 4096*4096' -r
...
complete -c merman-cli -n "__fish_merman_cli_using_subcommand batch" -s t -l theme -d 'Mermaid theme override' -r
...
ratex\t''"
complete -c merman-cli -n "__fish_merman_cli_using_subcommand batch" -s w -l width -d 'Available container width for size-sensitive layouts. `mmdc` defaults to 800' -r
complete -c merman-cli -n "__fish_merman_cli_using_subcommand batch" -s H -l height -d 'Available container height for size-sensitive layouts. `mmdc` defaults to 600' -r
...
complete -c merman-cli -n "__fish_merman_cli_using_subcommand batch" -l raster-unbounded -d 'Disable PNG/JPG raster size limits. Use only for trusted oversized exports'
...
complete -c merman-cli -n "__fish_merman_cli_using_subcommand mmdc" -s s -l scale -d 'PNG/JPG scale factor. Defaults to 1' -r
complete -c merman-cli -n "__fish_merman_cli_using_subcommand mmdc" -l raster-fit-width -d 'Fit PNG/JPG raster output to this CSS-pixel width before applying --scale' -r
complete -c merman-cli -n "__fish_merman_cli_using_subcommand mmdc" -l raster-fit-height -d 'Fit PNG/JPG raster output to this CSS-pixel height before applying --scale' -r
complete -c merman-cli -n "__fish_merman_cli_using_subcommand mmdc" -l raster-max-width -d 'Maximum PNG/JPG output width after scale and fit. Defaults to 4096' -r
complete -c merman-cli -n "__fish_merman_cli_using_subcommand mmdc" -l raster-max-height -d 'Maximum PNG/JPG output height after scale and fit. Defaults to 4096' -r
complete -c merman-cli -n "__fish_merman_cli_using_subcommand mmdc" -l raster-max-pixels -d 'Maximum PNG/JPG output pixels after scale and fit. Defaults to 4096*4096' -r
...
complete -c merman-cli -n "__fish_merman_cli_using_subcommand mmdc" -l raster-unbounded -d 'Disable PNG/JPG raster size limits. Use only for trusted oversized exports'
...
complete -c merman-cli -n "__fish_merman_cli_using_subcommand detect" -s c -l config-file -d 'JSON Mermaid configuration file' -r -F
complete -c merman-cli -n "__fish_merman_cli_using_subcommand detect" -s t -l theme -d 'Mermaid theme override' -r
complete -c merman-cli -n "__fish_merman_cli_using_subcommand detect" -l runtime -d 'Runtime source for clock, local timezone, and operation randomness' -r -f -a "deterministic\t''
native\t''"
complete -c merman-cli -n "__fish_merman_cli_using_subcommand detect" -l fixed-today -d 'Override the local "today" date for time-dependent diagrams' -r
complete -c merman-cli -n "__fish_merman_cli_using_subcommand detect" -l fixed-local-offset-minutes -d 'Override the local timezone offset in minutes for time-dependent diagrams' -r
complete -c merman-cli -n "__fish_merman_cli_using_subcommand detect" -l resource-profile -d 'Resource policy for input, semantic models, output, and CLI acquisition' -r -f -a "interactive\t'General interactive applications and public binding surfaces'
constrained\t'Constrained rendering for untrusted or publicly submitted documents'
trusted-native\t'Local CLI and controlled native batch rendering'
unbounded-for-trusted-input\t'Explicitly disable policy budgets while retaining hard backend capabilities'"
complete -c merman-cli -n "__fish_merman_cli_using_subcommand detect" -l resource-limit -d 'Override a resource budget as STABLE_ID=POSITIVE_U64. Can be repeated' -r
complete -c merman-cli -n "__fish_merman_cli_using_subcommand detect" -l system-clock -d 'Use the system clock while keeping other runtime sources deterministic'
complete -c merman-cli -n "__fish_merman_cli_using_subcommand detect" -l system-timezone -d 'Use the system local timezone while keeping other runtime sources deterministic'
complete -c merman-cli -n "__fish_merman_cli_using_subcommand detect" -l system-random -d 'Use system randomness while keeping other runtime sources deterministic'
complete -c merman-cli -n "__fish_merman_cli_using_subcommand detect" -l system-timing -d 'Enable operation timing diagnostics through the compiled system timing adapter'
...
complete -c merman-cli -n "__fish_merman_cli_using_subcommand parse" -s t -l theme -d 'Mermaid theme override' -r
...
complete -c merman-cli -n "__fish_merman_cli_using_subcommand layout" -s t -l theme -d 'Mermaid theme override' -r
