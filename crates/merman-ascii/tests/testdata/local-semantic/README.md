...
Current covered Class capabilities include association (`--` / `..`), inheritance, realization, aggregation, composition, endpoint cardinality labels, multiline labels, parallel lanes, crossing reroutes, dense summary fallback, and tight-budget summary fallback.
...
Current explicit unsupported boundaries are covered by typed-model tests for Class lollipop relations and multiple markers, plus ER unknown cardinality markers and unknown relationship identification types.
