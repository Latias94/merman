...
diagram families have opt-in ANSI/HTML foreground color roles through `AsciiColorMode`; Mermaid
style/class/linkStyle and fill/background color interpretation remain follow-on work.
