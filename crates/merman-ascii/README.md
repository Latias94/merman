...
single-line notes, sequence boxes, activations, actor create/destroy lifecycle markers, and visible
autonumber can render through `render_sequence` or `render_model`.
