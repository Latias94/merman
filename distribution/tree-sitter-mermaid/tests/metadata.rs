...
#[test]
fn package_identity_matches_the_generated_language_contract() {
    ...
    assert!(ARTIFACT_RECEIPT.contains("\"treeSitterCli\": \"0.26.12\""));
    assert!(ARTIFACT_RECEIPT.contains("\"abi\": 14"));
}
