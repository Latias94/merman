; Zed highlight profile. Semantic patterns mirror the portable profile,
; while capture names follow the pinned Zed theme vocabulary.
...
(architecture_group_statement
  id: (architecture_identifier) @type)
...
(architecture_parent_clause
  parent: (architecture_identifier) @type)
...
(gantt_constraint_keyword) @operator
...
(requirement_relationship_kind) @operator
...
(c4_relationship_kind) @operator
(c4_update_kind) @function
...
(sequence_note_placement) @operator
