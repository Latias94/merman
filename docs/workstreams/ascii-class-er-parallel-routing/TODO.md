...
- [x] ACEPR-040 [owner=codex] [deps=ACEPR-030] [scope=crates/merman-ascii,docs]
  ...
  Handoff: DONE. Support docs now describe same-endpoint parallel lanes, full package gates pass,
  and broader topology work remains deferred outside this lane.
