...
- [x] RSO-030 [owner=codex] [deps=RSO-020] [scope=crates/merman-render/src/svg,crates/merman/src/lib.rs]
  ...
  Evidence: `crates/merman-render/src/svg/pipeline.rs`, `crates/merman/src/lib.rs`.
  Handoff: DONE.

- [x] RSO-040 [owner=codex] [deps=RSO-030] [scope=crates/merman/src/lib.rs,crates/merman/src/render/raster.rs,crates/merman-cli/src/main.rs]
  ...
  Evidence: readable helper tests, `render::raster` routing, CLI raster smoke tests.
  Handoff: DONE.

## M3 - Resvg-Safe Built-ins

- [x] RSO-050 [owner=codex] [deps=RSO-040] [scope=crates/merman-render/src/svg]
  ...
  Evidence: `resvg_safe_pipeline_strips_generic_raster_hazards`.
  Handoff: DONE.

## M4 - Host Extension API

- [x] RSO-060 [owner=codex] [deps=RSO-050] [scope=crates/merman-render/src/svg,crates/merman/src/lib.rs]
  ...
  Evidence: custom postprocessor ordering/error tests and `SvgPipeline::with_postprocessor`.
  Handoff: DONE.

- [x] RSO-070 [owner=codex] [deps=RSO-060] [scope=README.md,CHANGELOG.md,docs/rendering]
  ...
  Evidence: `README.md`, `docs/rendering/SVG_OUTPUT_PIPELINE.md`,
  `docs/rendering/RASTER_OUTPUT.md`, `CHANGELOG.md`.
  Handoff: DONE.

## M5 - Verification And Closeout

- [x] RSO-080 [owner=codex] [deps=RSO-070] [scope=docs/workstreams/resvg-safe-svg-output]
