...
- [x] PUP-020 [owner=codex] [deps=PUP-010] [scope=bindings/python/merman-uniffi,crates/merman-uniffi]
  ...
  Context: docs/workstreams/python-uniffi-package/CONTEXT.jsonl
  Handoff: DONE. Added `bindings/python/merman-uniffi` package scaffold, generated artifact ignores,
