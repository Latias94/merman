...
- Current Sequence root viewport overrides: `70` entries after the follow-up Sequence
...
- Current root viewport override budget: `373` entries.
- Current SVG text metric table budget: `186` rows after adding two Sequence message-width facts
  ...
  title/accessibility, simple Cypress, arrow variant, and package sequence clusters.
