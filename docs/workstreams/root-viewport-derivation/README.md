...
- Current GitGraph root viewport overrides: `156` entries after deriving GitGraph title text
  ...
  pins.
- Current Flowchart root viewport overrides: `112` entries after deriving imageSquare
  image-plus-label layout bounds and anchor dot layout bounds, then pruning the now-derived docs
  parameters and old-shape set5 pins.
- Current root viewport override budget: `532` entries.
