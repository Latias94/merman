...
| `crates/merman-core/src/diagrams/flowchart.rs` | `clippy::type_complexity`, `clippy::result_large_err` | Parser boundary allowance around generated LALRPOP code. | Audit only after changing the generated parser/error shape; do not treat this as local hand-written cleanup. |
| `crates/merman-core/src/diagrams/sequence/mod.rs` | `clippy::type_complexity`, `clippy::result_large_err` | Parser boundary allowance around generated LALRPOP code. | Audit only after changing the generated parser/error shape; do not treat this as local hand-written cleanup. |
...
| `crates/merman-core/src/diagrams/flowchart/ast.rs` | `clippy::large_enum_variant` | Structural AST issue on `flowchart::Stmt`; parser and semantic application both consume the shape. | Box large AST variants only with parser snapshot coverage and flowchart DOM parity checks. |
