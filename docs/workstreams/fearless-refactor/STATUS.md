...
- Root viewport override no-growth is tightened to `545` after the GitGraph horizontal
  branch-label width pass.
...
- root viewport: `gitgraph` 156, `flowchart` 125, `sequence` 79, `mindmap` 39, `c4` 35,
  `state` 34
