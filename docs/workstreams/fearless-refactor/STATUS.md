...
- Root viewport override no-growth is tightened to `532` after the GitGraph horizontal
...
- root viewport: `gitgraph` 156, `flowchart` 112, `sequence` 79, `mindmap` 39, `c4` 35,
  `state` 34
