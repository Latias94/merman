...
- Root viewport override no-growth is tightened to `379` after the GitGraph seeded auto-id
  ...
  `activation_explicit` and stacked-activation message-width fact corrections.
...
- root viewport: `flowchart` 95, `sequence` 76, `mindmap` 39, `c4` 35,
  `state` 34
