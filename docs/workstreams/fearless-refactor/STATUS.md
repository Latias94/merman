...
- Root viewport override no-growth is tightened to `602` after the Sequence frontmatter-title
  root-bounds follow-up.
...
- root viewport: `gitgraph` 213, `flowchart` 125, `sequence` 79, `mindmap` 39, `c4` 35,
  `state` 34
