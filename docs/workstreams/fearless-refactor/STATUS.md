...
- Root viewport override no-growth is tightened to `544` after the GitGraph horizontal
  branch-label width pass and the Flowchart imageSquare layout-bounds pass.
...
- root viewport: `gitgraph` 156, `flowchart` 124, `sequence` 79, `mindmap` 39, `c4` 35,
  `state` 34
