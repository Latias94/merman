...
- Root viewport override no-growth is tightened to `377` after the GitGraph seeded auto-id
  ...
  message-width fact corrections.
...
- root viewport: `flowchart` 95, `sequence` 74, `mindmap` 39, `c4` 35,
  `state` 34
