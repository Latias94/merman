...
- Root viewport override no-growth is tightened to `530` after the GitGraph horizontal
  ...
  SVG-like subgraph-title/root-bounds pass.
...
- root viewport: `gitgraph` 156, `flowchart` 110, `sequence` 79, `mindmap` 39, `c4` 35,
  `state` 34
