...
- Root viewport override no-growth is tightened to `526` after the GitGraph horizontal
  ...
  title-margin root-pin deletions and the Flowchart HTML-label font-size precedence derivation.
...
- root viewport: `gitgraph` 156, `flowchart` 106, `sequence` 79, `mindmap` 39, `c4` 35,
  `state` 34
