...
- [ ] Delete overrides made obsolete by typed model or measurement fixes.
  Evidence: 59 root viewport overrides have been removed so far: 19 `architecture` entries after
  ...
  covered by deterministic root output. One additional hand-curated `kanban` helper was removed by
