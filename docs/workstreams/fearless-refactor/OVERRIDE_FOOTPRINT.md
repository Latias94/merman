...
cleanups, reducing the text lookup total to 499.
...
Total lookup entries reported by `xtask`: `499`.

| file | lookup entries |
| --- | ---: |
| `block_text_overrides_11_12_2.rs` | 123 |
| `class_text_overrides_11_12_2.rs` | 296 |
...
total to 296 and the global text lookup total to 499.
