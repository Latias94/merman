...
the `+isOk() : bool` rendered-width cleanup, reducing the text lookup total to 483.
...
Total lookup entries reported by `xtask`: `483`.

| file | lookup entries |
| --- | ---: |
| `block_text_overrides_11_12_2.rs` | 123 |
| `class_text_overrides_11_12_2.rs` | 280 |
...
and reduced the Class text lookup total to 280 and the global text lookup total to 483.
