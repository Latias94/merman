...
- Class text lookup debt dropped by 38 entries after the exact deterministic fallback pass, the
  ...
  `Mineral` calc cleanups, followed by the `Duck`, `Item`, and `Order` cleanups, stayed green
