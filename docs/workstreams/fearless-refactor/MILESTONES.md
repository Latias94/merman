...
- Class text lookup debt dropped by 50 entries after the exact deterministic fallback pass, the
  ...
  `may-fail` cleanups, stayed green under Class DOM parity, layout snapshot, and strict gates,
  reducing the global text lookup total to 497.
