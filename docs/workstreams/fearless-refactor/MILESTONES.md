...
- Class text lookup debt dropped by 47 entries after the exact deterministic fallback pass, the
  ...
  `builds`, `parses`, `emits`, `feedback`, `returns`, `wraps`, and `reads` cleanups, stayed green
