...
- Root viewport overrides dropped 47 fixture-specific entries so far: 19 architecture pins after
  ...
  by deterministic emitted bounds and 9 timeline pins now covered by deterministic root output.
