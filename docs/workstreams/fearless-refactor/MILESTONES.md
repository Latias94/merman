...
- Root viewport overrides dropped 106 fixture-specific entries so far: 19 architecture pins after
  ...
  root output and 35 requirement pins now covered by deterministic root output.
