...
- Active unit: final quality gates and review.
...
Run final verification gates, perform the required review pass, commit U7 docs/memory, and close the goal if no actionable findings remain.
