...
Inspect Timeline, C4, Architecture, and Kanban handwritten parser errors. Migrate only deterministic parser-local spans; for remaining imprecision, use visible named fallback constructors and document capability boundaries.
