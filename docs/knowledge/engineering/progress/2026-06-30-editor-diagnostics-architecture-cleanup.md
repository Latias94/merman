...
- Active unit: U5, preview control and interaction polish.
...
Inspect the VS Code preview shell, source actions, and webview tests for U5. Keep diagnostics compact, make common export/copy actions visible, and preserve pan/zoom across cursor or diagnostics-only updates.
