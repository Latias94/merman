...
- Active unit: U6, redundant compatibility path cleanup.
...
Run U6 cleanup searches and delete any remaining compatibility code or stale terminology that is no longer test-backed.
