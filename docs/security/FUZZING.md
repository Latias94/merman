...
| `tree_sitter_mermaid_parse` | Arbitrary-byte Tree-sitter fresh parsing, repeat determinism, and bounded CST spans | `fuzz/seeds/mermaid` | `fuzz/dictionaries/mermaid.dict` |
...
cargo +nightly-2026-07-01 fuzz run --fuzz-dir fuzz --sanitizer address tree_sitter_mermaid_parse fuzz/corpus/tree_sitter_mermaid_parse fuzz/seeds/mermaid -- -runs=64 -timeout=10 -max_len=262144 -dict=fuzz/dictionaries/mermaid.dict
