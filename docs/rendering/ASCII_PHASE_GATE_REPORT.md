...
| Phase 1: Flowchart and Sequence | Complete at Partial | The immutable graph corpus is 45/79 exact plus 34 named renderable differences. Sequence keeps 17/17 normalized copied parity. Imported Mermaid fixtures prove parser/render admission; promoted local semantic probes own broader marker, compound, signal, control, lifecycle, and actor claims. | Common families remain Partial where documented residuals exist; their evidence is not weakened to make a new family easier to add. |
