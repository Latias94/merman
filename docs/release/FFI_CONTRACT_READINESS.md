...
| --- | --- | --- | --- |
| `public-native` | green | C ABI 3, Android JNI transport API 2, UniFFI API 4, and the shared default native prebuilt SKU | current artifact-profile dependency claims and the platform verification script |
