# Flowchart Upstream Test Coverage (Mermaid@11.12.3)
...
- `fixtures/flowchart/upstream_html_demos_flowchart_graph_039_parser_only_katex.mmd`
...
- `fixtures/flowchart/upstream_html_demos_flowchart_flowchart_040_parser_only_katex.mmd`
- `fixtures/flowchart/upstream_html_demos_flowchart_flowchart_042_parser_only_katex.mmd`
- `fixtures/flowchart/upstream_html_demos_flowchart_flowchart_044_parser_only_katex.mmd`
...
- The four historical `*_parser_only_katex` Flowchart HTML-demo fixtures are no longer parser-only. They now run through the opt-in
