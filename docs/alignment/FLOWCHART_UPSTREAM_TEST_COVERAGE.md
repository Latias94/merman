# Flowchart Upstream Test Coverage (Mermaid@11.16.0)
...
- `fixtures/flowchart/upstream_cypress_flowchart_handdrawn_spec_fdh31_should_not_slice_off_edges_that_are_to_the_left_of_the_lef_031.mmd`
- `fixtures/flowchart/upstream_cypress_flowchart_handdrawn_spec_fdh40_handle_styling_with_style_expressions_038.mmd`
...
- `fixtures/flowchart/upstream_cypress_flowchart_handdrawn_spec_fdh46_text_color_from_classes_044.mmd`
- `fixtures/flowchart/upstream_cypress_flowchart_handdrawn_spec_fdh47_apply_class_called_default_on_node_called_default_045.mmd`
...
- `fixtures/flowchart/upstream_cypress_flowchart_handdrawn_spec_fhd18_chaining_of_nodes_018.mmd`
- `fixtures/flowchart/upstream_cypress_flowchart_handdrawn_spec_fhd19_multiple_nodes_and_chaining_in_one_statement_019.mmd`
...
- `fixtures/flowchart/upstream_cypress_flowchart_handdrawn_spec_fhd8_should_render_labels_with_numbers_at_the_start_008.mmd`
...
- `fixtures/flowchart/upstream_cypress_flowchart_v2_spec_5_should_render_escaped_without_html_labels_005.mmd`
- `fixtures/flowchart/upstream_cypress_flowchart_v2_spec_6_should_render_non_escaped_with_html_labels_006.mmd`
...
- `fixtures/flowchart/upstream_cypress_flowchart_v2_spec_61_fontawesome_icons_in_edge_labels_021.mmd`
- `fixtures/flowchart/upstream_cypress_flowchart_v2_spec_62_should_render_styled_subgraphs_022.mmd`
- `fixtures/flowchart/upstream_cypress_flowchart_v2_spec_58_handle_styling_with_style_expressions_018.mmd`
- `fixtures/flowchart/upstream_cypress_flowchart_v2_spec_65_2_bold_text_from_classes_025.mmd`
- `fixtures/flowchart/upstream_cypress_flowchart_v2_spec_1433_should_render_a_titled_flowchart_with_titletopmargin_set_to_040.mmd`
- `fixtures/flowchart/upstream_cypress_flowchart_v2_spec_3192_it_should_be_possible_to_render_flowcharts_with_invisible_e_041.mmd`
- `fixtures/flowchart/upstream_cypress_flowchart_v2_spec_3258_should_render_subgraphs_with_main_graph_nodespacing_and_ran_046.mmd`
- `fixtures/flowchart/upstream_cypress_flowchart_v2_spec_3258_should_render_subgraphs_with_large_nodespacing_and_rankspac_047.mmd`
- `fixtures/flowchart/upstream_cypress_flowchart_v2_spec_should_render_a_diamond_shaped_node_using_shape_config_069.mmd`
...
- `fixtures/flowchart/upstream_cypress_flowchart_handdrawn_spec_fdh34_testing_the_label_width_in_percy_034.mmd`
- `fixtures/flowchart/upstream_cypress_flowchart_handdrawn_spec_fdh36_should_render_escaped_without_html_labels_036.mmd`
- `fixtures/flowchart/upstream_cypress_flowchart_handdrawn_spec_fdh42_fontawesome_icons_in_edge_labels_040.mmd`
...
- `fixtures/flowchart/upstream_cypress_flowchart_handdrawn_spec_fdh48_should_be_able_to_style_default_node_independently_048.mmd`
...
- `fixtures/flowchart/upstream_cypress_flowchart_spec_70_should_render_a_subgraph_with_direction_td_050.mmd`
...
- `fixtures/flowchart/upstream_cypress_flowchart_v2_spec_2388_handling_default_in_the_node_name_038.mmd`
- `fixtures/flowchart/upstream_cypress_flowchart_v2_spec_2824_clipping_of_edges_039.mmd`
...
- `fixtures/flowchart/upstream_cypress_flowchart_v2_spec_4439_should_render_the_graph_even_if_some_images_are_missing_043.mmd`
...
- `fixtures/flowchart/upstream_cypress_flowchart_v2_spec_76_handle_unicode_encoded_character_with_html_labels_true_036.mmd`
- `fixtures/flowchart/upstream_cypress_flowchart_v2_spec_65_3_bigger_font_from_classes_026.mmd`
- `fixtures/flowchart/upstream_cypress_flowchart_v2_spec_should_be_possible_to_use_syntax_to_add_labels_on_multi_nodes_064.mmd`
...
- The four former parser-only KaTeX Flowchart HTML-demo fixtures are stored as renderable `*_katex`
  fixtures. They run through the opt-in Node/Puppeteer KaTeX backend and are gated by
...
- subgraph direction statements (`direction BT|RL|LR|TD` etc), raw `TD` preservation inside
  subgraphs, and “last wins”: unit test
  `parse_diagram_flowchart_subgraph_direction_statement_sets_dir` in `crates/merman-core/src/lib.rs`
...
- Mermaid 11.16 parser regression “should correctly parse direction TD inside a subgraph” is
  covered by `parse_diagram_flowchart_subgraph_direction_statement_sets_dir`; root graph header
  `TD` still normalizes to `TB`, while subgraph-local explicit `direction TD` remains raw `TD`.
...
These are upstream Mermaid `@11.16.0` behaviors worth calling out explicitly because they are
