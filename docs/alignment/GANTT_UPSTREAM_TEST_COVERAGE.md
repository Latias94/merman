# Gantt Upstream Test Coverage (Mermaid@11.16.0)
...
- Rust unit tests under `crates/merman-core/src/diagrams/gantt/tests.rs`

Headless layout coverage for the same fixture set is tracked via layout snapshots:
...
- duration parsing (`parseDuration`): unit tests in `crates/merman-core/src/diagrams/gantt/tests.rs`
