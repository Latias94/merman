# Mindmap Upstream Test Coverage (Mermaid@11.12.3)
...
- Rust unit tests under `crates/merman-core/src/diagrams/mindmap/tests.rs`
...
- MMP-5 multiple roots are illegal: unit test `mindmap_multiple_roots_is_error` in `crates/merman-core/src/diagrams/mindmap/tests.rs`
- MMP-6 real root in wrong place: unit test `mindmap_real_root_in_wrong_place_is_error` in `crates/merman-core/src/diagrams/mindmap/tests.rs`
