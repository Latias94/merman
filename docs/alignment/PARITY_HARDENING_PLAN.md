...
- `parity-root` full compare: 0 mismatch (481/481 upstream SVG baselines).
...
- Total upstream SVG baselines: 481
...
- `architecture_root_overrides_11_12_2.rs`: 21 entries (out of 29 architecture fixtures)
