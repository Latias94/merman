...
- `parity-root` full compare: 0 mismatch (475/475 upstream SVG baselines).
...
- Total upstream SVG baselines: 475
...
- `architecture_root_overrides_11_12_2.rs`: 17 entries (out of 25 architecture fixtures)
- `class_root_overrides_11_12_2.rs`: 8 entries (out of 16 class fixtures)
- `mindmap_root_overrides_11_12_2.rs`: 6 entries (out of 11 mindmap fixtures)
