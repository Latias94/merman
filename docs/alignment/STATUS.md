...
As of 2026-03-08, `xtask compare-svg-xml --diagram block --dom-mode strict --dom-decimals 3` reports 59 block
...
and restoring Mermaid marker/style attributes; strict XML compare also normalizes block's randomized auto-generated
internal ids so the remaining diff set is dominated by real geometry/style gaps rather than UUID noise.
