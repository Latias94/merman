...
- Current corpus (2026-02-23): 1937 baselines across 23 diagrams.
...
As of 2026-02-23, `xtask compare-all-svgs --check-dom --dom-mode parity-root --dom-decimals 3` reports 0 DOM
mismatches for the current fixture set (1937/1937 upstream SVG baselines, including root viewport parity).
