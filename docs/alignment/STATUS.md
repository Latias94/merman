...
As of 2026-02-10, `xtask compare-all-svgs --check-dom --dom-mode parity-root --dom-decimals 3` reports 0 DOM
mismatches for the current fixture set (592/592 upstream SVG baselines, including root viewport parity).
