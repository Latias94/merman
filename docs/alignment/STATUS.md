...
- Current corpus (2026-02-17): 1938 baselines across 23 diagrams.
...
As of 2026-02-17, `xtask compare-all-svgs --check-dom --dom-mode parity-root --dom-decimals 3` reports 0 DOM
mismatches for the current fixture set (1938/1938 upstream SVG baselines, including root viewport parity).
