...
- Upstream SVG baselines (`fixtures/upstream-svgs/**`):
  ...
  - Current corpus (2026-02-14): 1181 baselines across 23 diagrams.
...
mismatches for the current fixture set (1181/1181 upstream SVG baselines, including root viewport parity).
