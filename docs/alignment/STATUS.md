...
- Upstream SVG baselines (`fixtures/upstream-svgs/**`):
  ...
  - Current corpus (2026-02-13): 952 baselines across 23 diagrams.
...
mismatches for the current fixture set (903/903 upstream SVG baselines, including root viewport parity).
