...
- Current corpus (2026-02-23): 1977 baselines across 23 diagrams.
...
As of 2026-02-23, `xtask compare-all-svgs --check-dom --dom-mode parity --dom-decimals 3` reports 0 DOM
