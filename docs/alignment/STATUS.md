...
- Upstream SVG baselines (`fixtures/upstream-svgs/**`):
  ...
  - Current corpus (2026-02-14): 1195 baselines across 23 diagrams.
...
mismatches for the current fixture set (1195/1195 upstream SVG baselines, including root viewport parity).
