...
- Upstream SVG baselines (`fixtures/upstream-svgs/**`):
  ...
  - Current corpus (2026-02-13): 863 baselines across 23 diagrams.
...
mismatches for the current fixture set (863/863 upstream SVG baselines, including root viewport parity).
