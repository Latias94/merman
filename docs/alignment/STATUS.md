...
- Upstream SVG baselines (`fixtures/upstream-svgs/**`):
  ...
  - Current corpus (2026-02-14): 1150 baselines across 23 diagrams.
...
mismatches for the current fixture set (1150/1150 upstream SVG baselines, including root viewport parity).
