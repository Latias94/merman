...
- Upstream SVG baselines (`fixtures/upstream-svgs/**`):
  ...
  - Current corpus (2026-02-14): 1208 baselines across 23 diagrams.
...
mismatches for the current fixture set (1208/1208 upstream SVG baselines, including root viewport parity).
