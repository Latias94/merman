...
- Upstream SVG baselines (`fixtures/upstream-svgs/**`):
  ...
  - Current corpus (2026-02-14): 1138 baselines across 23 diagrams.
...
mismatches for the current fixture set (1138/1138 upstream SVG baselines, including root viewport parity).
