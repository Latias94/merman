...
- Upstream SVG baselines (`fixtures/upstream-svgs/**`):
  ...
  - Current corpus (2026-02-14): 1197 baselines across 23 diagrams.
...
mismatches for the current fixture set (1197/1197 upstream SVG baselines, including root viewport parity).
