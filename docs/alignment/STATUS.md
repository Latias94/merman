...
- Upstream SVG baselines (`fixtures/upstream-svgs/**`):
  ...
  - Current corpus (2026-02-15): 1413 baselines across 23 diagrams.
...
mismatches for the current fixture set (1343/1343 upstream SVG baselines, including root viewport parity).
