...
- **Approach:**
  ...
  5. Replace the ordinary semaphore-plus-fallible-send choreography with one 96-entry queue whose owned permit is reserved before admission; keep four-way polling solely in the consumer. Publishing through the permit must not fail.
