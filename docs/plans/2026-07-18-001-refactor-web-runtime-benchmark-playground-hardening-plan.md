...
- **Test scenarios:**
  - Architecture guards reject old loader/hook/cache/warmup/detector/bench runner paths, direct Mermaid global mutations outside its realm owner, Mermaid external/CDN policy in `platforms/web`, public runtime/engine factories, and handwritten canonical example source.
