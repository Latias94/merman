...
export function packageEntrySource(descriptor) {
  ...
  return [
    ...
    "",
    "let wasmModulePromise: Promise<MermanWasmModule> | undefined;",
    "",
    "export function loadMermanWasmModule(): Promise<MermanWasmModule> {",
    "  assertBrowserRuntime();",
    "  wasmModulePromise ??= loadPackageWasmModule();",
    "  return wasmModulePromise;",
    "}",
    "",
    "async function loadPackageWasmModule(): Promise<MermanWasmModule> {",
    ...
    "  return {",
    "    ...module,",
    "    default(input?: Parameters<MermanWasmModule[\"default\"]>[0]) {",
