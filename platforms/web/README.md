...
browser preview normally uses the `interactive` profile, while a public submission service needs
host-level hard timeouts, memory and concurrency controls, and process isolation in addition to
`constrained` limits.
