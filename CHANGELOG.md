...
- Hardened upstream SVG maintenance so full-family generation removes obsolete fixture baselines transactionally, compare readers cannot race shared Mermaid CLI installs, and root parity consumes root attributes captured from the locked compare generation. #21
