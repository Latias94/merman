...
- Prevented `resvg-safe` output from asking rasterizers to fill zero-area line paths, avoiding repeated Tiny-Skia warnings without changing their visible stroke.
