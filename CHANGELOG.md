...
- Marked low-level Graphlib, Manatee, and ELK error enums as non-exhaustive; downstream exhaustive matches over those implementation crates need a fallback arm.
