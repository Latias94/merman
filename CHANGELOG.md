...
- Made repeated default `Engine` construction substantially cheaper by sharing immutable pinned detector and parser registries through copy-on-write storage; per-engine custom registry changes remain isolated.
