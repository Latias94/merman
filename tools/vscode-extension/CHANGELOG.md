...
- Updated the extension runtime to the Mermaid 11.16 35-family parser-backed language stack, including the canonical token contract for diagnostics, completion, hover, navigation, rename, code actions, and symbols.
